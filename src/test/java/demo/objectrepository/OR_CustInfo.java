...
public interface OR_CustInfo {
    ...
    String cusSince = "id=customer_since1234";
    ...
    String billingStatusDropDown="xpath=//select[@id='project_state_name']";//Ready for FULL Billing
//String billingStatusDropDown="xapth=//option[@value='Ready for FULL Billing']";
  ...
  //  String configureUser_addEntrySuccessMessage="xpath=//*[@id='alert_placeholder']/div/span";
  ...
  //*[@id="userInfo"]/tbody/tr[1]/td[7]/select/option[2]
    ...
    String buildEnterprise_buildStatus="id=buildStatus";  //Build of TNs in Enterprise/Group '8JU8/8JU8-Holmdel' successful
        
    String buildEnterprise_buildEnterpriseGroup="id=buildEnterpriseGroup";  //after build message ->Build of Enterprise '8JU8' successful...
  ...
  // Home->C3->notification-e911-address-assignment
    ...
    //String attachments_documentName="xpath=//table[@class='table table-condensed']//tbody/tr";
   ...
   String customerTableHeadline="xpath=//*[@id='customer_table']/caption"; //Customers
    ...
    String queues_createAProjectOntoStep_DueDate="xpath=(//div/span[contains(text(),'Select Date')])[3]"; //2nd day from today
    String queues_createAProjectOntoStep_buildProjectTask="xpath=(//button[@class='btn btn-success'])[2]";
    
    String queues_createAProjectOntoStep_projectStatus_DD="id=project_state_name";  //Ready for FULL Billing
    ...
    //String queue_billing_pushToBilling_addToEngage="xpath=//div[@class='customerinfo']/form/div[2]/div[6]/input";
...
//String dashBoard_data_cdr_config_checkBoxEnable="xpath=//*[@id='cdrFields']/tbody/tr/td[1]/div";
