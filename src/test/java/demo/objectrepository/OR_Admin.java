...
public interface OR_Admin {
	...
	// String
	// customer_portal_msg_of_the_day="id:notification-message-of-the-day";
	String customer_portal_msg_of_the_day = "xpath=//a[@href='/messageOfTheDay']";
	// String
	// customer_portal_msg_of_the_day="xpath=//*[@id='header_list']/li[2]/ul/li[4]/ul";
	...
	/*
	 * String
	 * inventory_netcMapping="xpath=//*[@id='header_list']/li[2]/ul/li[10]/ul/li[1]"
	 * ; String inventory_partsListMappings=
	 * "xpath=//*[@id='header_list']/li[2]/ul/li[10]/ul/li[2]"; String
	 * inventory_uploadNextReport
	 * ="xpath=//*[@id='header_list']/li[2]/ul/li[10]/ul/li[3]";
	 */
	...
	// String admin_menu_reconcilation_reconmac_mapping_addmapping_search_field
	// ="xpath=//div[@class='dataTables_filter']";
	...
	String admin_salesTools_cicuit_quote_customerId_status = "id=cn"; // Vonage
																		// Corporate
	String admin_salesTools_cicuit_quote_submit_status = "xpath=//div[@class='alert alert-danger']"; // Error!
																										// Cannot
																										// not
																										// get
																										// a
	...
	String engineering_carriers_carrierSection_carrierState_DD = "xpath=//*[@id='carrier_state_id']";
